...
export const UserController = {
  ...
  async update(req: Request, res: Response) {
    ...
    const updateUserResponse = await UserModel.update(
      id as string,
      updatedUser,
    );
  ...
  async login(req: Request, res: Response) {
    ...
    const userData: UserType | null = await UserModel.getByEmail(
      email as string,
    );
  ...
  async resetPassword(req: Request, res: Response) {
    ...
    const resetPasswordResponse = await UserModel.resetPassword(
      id as string,
      updatedUser.password,
    );
